            ...
            >
              <TableHead>
                <TableRow style={{ background: "#ECFFDC" }}>
                  ...
                  <TableCell>age&nbsp;(Entier)</TableCell>
              ...
              <TableBody>
                {persons
                  .filter(
                    (person) =>
                      person.nom.toLowerCase().includes(nomPrenom) ||
                      person.prenom.toLowerCase().includes(nomPrenom)
                  )
                  .map((row) => (
                    <TableRow
                      key={row.personid}
                    ...
                    >
                      ...
                      <TableCell align="left">{row.nationaliteid}</TableCell>
                    </TableRow>
                  ))}
              </TableBody>
            </Table>
