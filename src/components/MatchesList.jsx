  ...
  return (
    <>
      <Box sx={{ display: "flex" }}>
        ...
        >
          <Toolbar />
          <img src={edf} alt="" width="800" height="500" />
          <Typography
            fontFamily={"serif"}
            fontSize={16}
            textAlign={"justify"}
            ...
            >
              <TableHead>
                <TableRow style={{ background: "#ECFFDC" }}>
                  ...
                  <TableCell>pays1id</TableCell>
                  <TableCell>pays2id</TableCell>
                  <TableCell>nom1</TableCell>
                  <TableCell>scorepays1</TableCell>
                  <TableCell>scorepays2</TableCell>
                  <TableCell>nom2</TableCell>
                  <TableCell>lieu&nbsp;(Entier)</TableCell>
                  <TableCell>date</TableCell>
                  <TableCell>arbitreid</TableCell>
                </TableRow>
              </TableHead>
              ...
              <TableBody>
                {joueurs.map((row) => (
                  ...
                  >
                    {console.log(row)}
                    <TableCell align="left">{row.matchid}</TableCell>
                    <TableCell align="left">{row.pays1id}</TableCell>
                    <TableCell align="left">{row.pays2id}</TableCell>
                    <TableCell align="left">{row.nom1}</TableCell>
                    <TableCell align="left">{row.scorepays1}</TableCell>
                    <TableCell align="left">{row.scorepays2}</TableCell>
                    <TableCell align="left">{row.nom2}</TableCell>
                    <TableCell align="left">{row.lieu}</TableCell>
                    <TableCell align="left">{row.date}</TableCell>
                    <TableCell align="left">{row.arbitreid}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
